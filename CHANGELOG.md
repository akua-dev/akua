...
internal security audit (no sandbox-escape was found — these are supply-chain
integrity + DoS-resilience hardening). See
[docs/security-audit-2026-05-29.md](docs/security-audit-2026-05-29.md).
